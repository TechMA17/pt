...
import com.citi.posttradeanalyzer.data.MemberRepository;
import com.citi.posttradeanalyzer.service.HafizUseThisClass;
import com.citi.posttradeanalyzer.service.MemberRegistration;
...
public class MemberResourceRESTService {
    ...
    @Path("/{graph}")
    @Produces(MediaType.TEXT_PLAIN)
    public String testMengying_Frontend(@PathParam("graph") String option) {
